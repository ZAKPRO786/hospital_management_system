...
def DELETE_DOCUSERS(request, id):
    try:
        docreg = get_object_or_404(DoctorReg, id=id)
        custom_user = docreg.admin  # Access the related CustomUser
        docreg.delete()  # This will also delete the associated CustomUser because of the on_delete=models.CASCADE
        custom_user.delete()
